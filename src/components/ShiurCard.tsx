    ...
    >
      ...
      <div className="p-3 flex flex-col gap-1 flex-1">
        ...
        <div className="mt-auto pt-1 flex flex-col gap-0.5">
          ...
          {(shiur.hebrewDate || shiur.publishedAtFormatted) && (
            <div className="flex items-center gap-1 mt-1">
              ...
              <div className="flex flex-col leading-none gap-0.5">
                {shiur.hebrewDate && (
                  <span className="text-xs text-gray-500 font-medium">{shiur.hebrewDate}</span>
                )}
                {shiur.publishedAtFormatted && (
                  <span className="text-[10px] text-gray-400">{shiur.publishedAtFormatted}</span>
                )}
              </div>
            </div>
          )}
